    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientsUnits", x => new { x.IngredientsId, x.UnitsId });
                    table.ForeignKey(
                        name: "FK_IngredientsUnits_Ingredients_IngredientsId",
                        column: x => x.IngredientsId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientsUnits_Units_UnitsId",
                        column: x => x.UnitsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipesGames", x => new { x.GamesId, x.RecipesId });
                    table.ForeignKey(
                        name: "FK_RecipesGames_Games_GamesId",
                        column: x => x.GamesId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipesGames_Recipes_RecipesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientsUnits_UnitsId",
                table: "IngredientsUnits",
                column: "UnitsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipesGames_RecipesId",
                table: "RecipesGames",
                column: "RecipesId");
